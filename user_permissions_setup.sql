-- Script para criar apenas a tabela de permissões de usuários
...
-- 9. Adicionar colunas à tabela sessions se não existirem
...
-- 10. Configurar RLS para sessions
ALTER TABLE sessions ENABLE ROW LEVEL SECURITY;

-- Política para sessions baseada em permissões
DROP POLICY IF EXISTS "Users can view sessions based on permissions" ON sessions;
DROP POLICY IF EXISTS "Users can manage sessions based on permissions" ON sessions;
